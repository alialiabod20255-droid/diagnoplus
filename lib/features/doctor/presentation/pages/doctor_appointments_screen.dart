...
class DoctorAppointmentsScreen extends StatefulWidget {
  ...
  const DoctorAppointmentsScreen({super.key, this.initialDate});
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text('$time - $reason'),
                          Text(
                            'الحالة: ${status == 'pending' ? 'جديد' : status == 'confirmed' ? 'تم الحضور' : 'ملغى'}',
                            style: TextStyle(
          ...
          Expanded(
            child: DropdownButton<String>(
              ...
              items: const [
                ...
                DropdownMenuItem(value: 'confirmed', child: Text('تم الحضور')),
